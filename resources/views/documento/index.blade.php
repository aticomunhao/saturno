                ...
                <div class="row">
                    ...
                    <div class="col-md-2 col-sm-12">Tipo Documento
                        <select class="form-select custom-select" style="border: 1px solid #999999; padding: 5px;"
                            ...
                            <option value="4">Termo doação</option>
                            <option value="5">Documento auxiliar da nota fiscal eletrônica</option>
                            <option value="6">Memorando</option>
                            <option value="7">Nota fiscal eletrônica</option>
                            <option value="8">Nota fiscal de serviço eletrônica</option>
                            <option value="9">Nota fiscal do consumidor eletrônica</option>
                            <option value="10">Conhecimento de transporte eletrônico</option>
                            <option value="11">Manifesto de documentos fiscais eletrônicos</option>
                            <option value="12">Pedido</option>
                            <option value="13">Boletim Administrativo</option>
                            <option value="14">Proposta comercial</option>
                        </select>
                    </div>
                    <div class="col" style="margin-top: 20px">
                        ...
                        <input class="btn btn-light btn-sm"
                               ...
                               value="Pesquisar">
                        <a href="incluir.html" class="btn btn-success btn-sm" type="button" name="6"
                           value="Novo Cadastro +"
