        ...
        <form action="{{ route('conta-contabil.update', $contaContabil->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="date" name="data_inicio" id="data_inicio" class="form-control"
                    value="{{ $contaContabil->data_inicio }}" required>
            </div>

            <div class="form-group">
                <label for="data_fim">Data Fim</label>
                <input type="date" name="data_fim" id="data_fim" class="form-control"
                    value="{{ $contaContabil->data_fim }}">
            </div>

            <div class="form-group">
                <label for="id_tipo_catalogo">Tipo de Catálogo</label>
                <input type="number" name="id_tipo_catalogo" id="id_tipo_catalogo" class="form-control"
                    value="{{ $contaContabil->id_tipo_catalogo }}" required>
            </div>

            <div class="form-group">
                <label for="descricao">Descrição</label>
                <input type="text" name="descricao" id="descricao" class="form-control"
                    value="{{ $contaContabil->descricao }}" required>
            </div>

            <div class="form-group">
                <label for="id_tipo_natureza_conta_contabil">Natureza Contábil</label>
                <input type="number" name="id_tipo_natureza_conta_contabil" id="id_tipo_natureza_conta_contabil"
                    class="form-control" value="{{ $contaContabil->id_tipo_natureza_conta_contabil }}" required>
            </div>

            <div class="form-group">
                <label for="id_tipo_grupo_conta_contabil">Grupo Contábil</label>
                <input type="number" name="id_tipo_grupo_conta_contabil" id="id_tipo_grupo_conta_contabil"
                    class="form-control" value="{{ $contaContabil->id_tipo_grupo_conta_contabil }}" required>
            </div>

            <div class="form-group">
                <label for="id_tipo_classe_conta_contabil">Classe Contábil</label>
                <input type="number" name="id_tipo_classe_conta_contabil" id="id_tipo_classe_conta_contabil"
                    class="form-control" value="{{ $contaContabil->id_tipo_classe_conta_contabil }}" required>
            </div>
                    ...
                    <div class="col-md-2 col-sm-12 form-group">
                        ...
                        <div class="input-group">
                            <select name="nivel_{{ $i }}" id="select-{{ $i }}"
                                class="form-control dynamic-select">
                                <option value="">Selecione</option>
                                @for ($j = 1; $j <= 99; $j++)
                                    <option value="{{ $j }}"
                                        {{ $contaContabil->{'nivel_' . $i} == $j ? 'selected' : '' }}>{{ $j }}
                                    </option>
                                @endfor
                            </select>
            ...
            <div class="form-group">
                ...
                <input type="number" name="grau" id="grau" class="form-control" value="{{ $contaContabil->grau }}"
                    required>
            </div>
                ...
                <div class="col-md-2 col-sm-12 form-group">
                    ...
                    <div class="input-group">
                        <select name="nivel_${i}" id="select-${i}" class="form-control dynamic-select">
                            <option value="">Selecione</option>
                            @for ($j = 1; $j <= 99; $j++)
                                <option value="{{ $j }}" ${i == ${i} ? 'selected' : ''}>{{ $j }}</option>
                            @endfor
                        </select>
                        <div class="input-group-append">
                            <button type="button" class="btn btn-secondary remove-field">
